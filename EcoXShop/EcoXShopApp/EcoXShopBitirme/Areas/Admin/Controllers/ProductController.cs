...
namespace EcoXShopBitirme.Areas.Admin.Controllers
{
    [Area("Admin")]
        ...
        public async Task<IActionResult> Create(Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                if (files.Count > 0)
                {
                    ...
                    var uploads = Path.Combine(_he.WebRootPath, @"template\images\product");
                    ...
                    product.Image = @"\template\images\product\" + fileName + ext;
                }
